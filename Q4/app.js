...
app.use(session({
    secret: 'Adopt a paw pal', // Choose a strong secret for session encryption
    resave: false,
...
app.get('/dogadoptionform', (req, res) => {
    // Use res.sendFile to serve the HTML file
   res.render("DogAdoptionForm", {})
});
app.get('/catadoptionform', (req, res) => {
    // Use res.sendFile to serve the HTML file
   res.render("CatAdoptionForm", {})
});
app.get('/dogtogiveaway', (req, res) => {
    // Use res.sendFile to serve the HTML file
   res.render("DogToGiveAway", {})
});
app.get('/cattogiveaway', (req, res) => {
    // Use res.sendFile to serve the HTML file
   res.render("CatToGiveAway", {})
});
app.get('/giveawaydone', (req, res) => {
    // Use res.render to return the give_away_done HTML file.
    res.render("giveawaydone", {});
});
app.get('/createaccount', (req, res) => {
    res.render('createaccount', { message: '' }); // Render with an empty message initially
});
...
app.post('/createaccount', (req, res) => {
    ...
    usernameExists(username, (err, exists) => {
        ...
        fs.appendFile(loginFile, `${username}:${password}\n`, (err) => {
            ...
            res.render('createaccount', { message: 'Account successfully created. You are now ready to login.' });
        });
    });
});
...
// app.post /find_dog
app.post('/dogadoptionform', (req, res) => {
    console.log("Adoption  dog form.");
    ...
    fs.readFile(availablePetInfoFile, 'utf8', (err, data) => {
        ...
        if (matches.length > 0) {
            ...
            res.render('availabledogs', { dogs: matches });
        } else {
...
// app.post /find_cat
app.post('/catadoptionform', (req, res) => {
    console.log("Adoption  cat form.");
    ...
    fs.readFile(availablePetInfoFile, 'utf8', (err, data) => {
        ...
        if (matches.length > 0) {
            ...
            res.render('availablecats', { cats: matches });
        } else {
...
app.post('/dogtogiveaway', (req, res) => {
    ...
    fs.appendFile(availablePetInfoFile, line, (err) => {
        ...
        res.redirect('/giveawaydone');
    });
});

// app.post /give_away_cat
app.post('/cattogiveaway', (req, res) => {
...
app.post('/log_in', (req, res) => {
    ...
    fs.readFile(loginFile, 'utf8', (err, data) => {
        ...
        if (exists) {
            ...
            res.render('haveapettogiveaway'); // Render the give away page if username and password match
        } else {
